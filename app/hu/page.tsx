  ...
  return (
    <main className="min-h-screen bg-black text-white scroll-smooth">
      ...
      <div className="pt-56 pb-24 text-center px-4">
        ...
        >
          Modern Weboldalak és Interaktív Virtuális Túrák
        </motion.p>
        <motion.a
          href="#contact"
      ...
      >
        ...
        <div className="relative max-w-3xl mx-auto">
          ...
          >
            Manapság minden a technológiáról szól — és mindenki online van.
            Segítek a vállalkozásoknak értékes kapcsolatokat építeni az
            emberekkel modern, magas teljesítményű weboldalak és magával ragadó
            virtuális túrák segítségével. <br className="hidden md:block" />
            <br />
            Az AD WEB Design-t azért alapítottam, hogy egyedi digitális
            élményeket készítsek, amelyek áthidalják a távolságot a cégek és
            ügyfeleik között. Olyan eszközökkel, mint a React, Next.js és
            Tailwind CSS, a modern dizájnt és a hatékony technológiát ötvözve
            segítem, hogy a márkád kitűnjön.
          </motion.p>
          ...
          <motion.p
            ...
            transition={{ delay: 0.2, duration: 0.6 }}
          >
            &quot;Hello, Ádám vagyok! Hadd segítsek megépíteni az álmaid
            weboldalát.&quot;
          </motion.p>
        </div>
      </section>
          ...
          <Link href="/hu/web">
            ...
            >
              ...
              <p className="text-zinc-300">
                Egyedi weboldalak modern dizájnnal, a React, Next.js, Node.js és
                MongoDB használatával.
              </p>
            </motion.div>
          </Link>

          <Link href="/hu/virtual">
            <motion.div
              className="cursor-pointer bg-zinc-900 p-6 rounded-2xl shadow-lg border border-zinc-800 hover:border-blue-300 transition-all duration-300"
              initial={{ opacity: 0, x: 200 }}
              whileInView={{ opacity: 1, x: 0 }}
            ...
            >
              ...
              <p className="text-zinc-300">
                Interaktív 360° virtuális élmények ingatlanokhoz, helyszínekhez
                és vállalkozásokhoz.
              </p>
            </motion.div>
          </Link>
        ...
        <div className="relative">
          ...
          <div className="relative max-w-2xl mx-auto">
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
              Írj nekem az elképzelésedről, és hamarosan felveszem veled a
              kapcsolatot!
            </motion.p>
            <form
              className="space-y-4"
              onSubmit={async (e: React.FormEvent<HTMLFormElement>) => {
                ...
                const response = await fetch("/api/contact", {
                  ...
                  body: JSON.stringify({ name, email, message, lang: "hu" }),
                });
